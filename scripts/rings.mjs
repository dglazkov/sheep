...
export const RINGS = {
  checkout: [
    ...
    "packages/cell/test/reset.test.ts",
    ...
    "packages/cli/test/blocks.test.ts",
  ...
  command: [
    ...
    "packages/cli/test/hill.test.ts",
    ...
    "packages/cli/test/shear.test.ts",

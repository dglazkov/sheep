...
/**
 * The bleat, the dog's side (bleat phase 1): the words live in
 * `setup-words.ts`, which the collie's Worker reads too; the watcher that
 * says them while a prompt is held is here.
 */
export { elapsed, SETUP_POLL_MS, SETUP_SAY_MS, setupSaying, SetupVoice } from "./setup-words.js";

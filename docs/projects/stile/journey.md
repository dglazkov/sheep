...
- The count for a first run is exactly: two values typed (the token and
  ...
  the environment of anything the dog runs afterwards. The account ring
  plays the shepherd through a terminal it owns and prints that count.

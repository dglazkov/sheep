...
[Project kennel](docs/projects/kennel/design.md) is the next: a dog's
...
follows it: a home in the cloud, from the package, in one path. Setup and usage are in [README.md](README.md).
